...
<template>
  <div
    class="flex max-w-full p-4 border-b border-gray-200 mx-auto bg-white border-b-solid break-words"
  >
    <div class="flex-shrink-0">
      <img
        class="size-3.5rem rounded-full"
    ...
    <div class="flex-1 ml-3 w-full">
      ...
      <div class="flex gap-8 opacity-50 w-full text-sm mt-2">
        ...
        <span class="cursor-pointer flex items-center gap-1"> <Reply /> 34 </span>
        <span class="cursor-pointer flex items-center gap-1"> <ThumbsUp /> 56 </span>
        <span class="cursor-pointer flex items-center gap-1">
          <Link />
        </span>
      </div>
