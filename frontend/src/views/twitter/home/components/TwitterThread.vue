...
<template>
    ...
    <div class="flex max-w-full p-4 border-b border-gray-200 mx-auto bg-white border-b-solid break-words">
        <div class="flex-shrink-0">
            <img class="size-3.5rem rounded-full"
                src="https://abs.twimg.com/sticky/default_profile_images/default_profile_400x400.png" alt="avatar" />
        </div>
        <div class="flex-1 ml-3 w-full">
            <div class="flex items-center text-sm text-gray-500">
                <span class="font-medium text-black text-1rem me-2">{{ randomString(param, nickname ?? "") }}</span>
