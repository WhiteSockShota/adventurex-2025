...
import { posts } from '@/entity/PostNew.ts'
...
<template>
    <div class="max-w-full max-h-full overflow-y-auto" id="container">
        <IconoirProvider :icon-props="{
            ...
            <div id="container">
                <TwitterThread v-for="(mock, index) in mockData" :key="index" :content="mock.content" :nickname="mock.nickname"
                    :username="mock.username" class="w-full" :start-shuffle-string="false" />
