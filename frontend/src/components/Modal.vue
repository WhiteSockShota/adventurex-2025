...
<template>
  <div v-if="modalStore.isVisible" class="fixed inset-0 bg-black/30 z-1 flex items-center justify-center p-4">
    <div ref="modalContent" class="bg-white rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] relative flex flex-col">
      <button @click="modalStore.hide()"
