...
<template>
  <div class="w-full h-screen bg-black text-white flex flex-col items-center justify-center relative overflow-hidden">
    ...
    <!-- 副标题 -->
    <p class="mt-4 text-lg z-10 text-gray-300">2060 年 7 月 27 日 · Dan 的居所</p>

    <!-- 引导文字 -->
    <p class="mt-8 text-center max-w-xl text-sm text-gray-400 z-10">
      「谢谢你」
    </p>
